...
phishing_email_5 = "As we prepare to start the 2019 Tax filling season, we have undergone slight changes in the filling process to make filling for your refund easier and to prevent unnecessary delays. "
phishing_email_6 = "Hello, You have an important email from the Human Resources Department with regards to your December 2020 Paycheck"
...
phishing_email_10 = "I recently read your last article and it was very useful in my field of research. I wonder, if possible, to send me these articles to use in my current research:This email is enclosed in the Raisoni College secure network, hence access it below. Access the documents here https://www.example.com, Ensure your login credentials are correct to avoid cancellations Part of the changes include updating our database with your information."
...
common_not_words = ['to', 'the', 'and', 'or', 'you', 'your', 'with',
                    'have', 'had', 'has', 'of', 'in', 'our', 'is', 'for', 'it', 'will','here', 'we'] # we exclude these words as they are very commonly used and do not represent the actual context
